<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{ invalid: !firstName.isValid }">
      ...
      />
      <p v-if="!firstName.isValid">The first name input can not be empty</p>
    </div>
    <div class="form-control" :class="{ invalid: !lastName.isValid }">
      ...
      />
      <p v-if="!lastName.isValid">The last name input can not be empty</p>
    </div>
    <div class="form-control" :class="{ invalid: !description.isValid }">
      ...
      ></textarea>
      <p v-if="!description.isValid">The description can not be empty</p>
    </div>
    ...
    <div class="form-control" :class="{ invalid: !areas.isValid }">
      ...
      <p v-if="!areas.isValid">Chose at least one area of expertise</p>
    </div>
